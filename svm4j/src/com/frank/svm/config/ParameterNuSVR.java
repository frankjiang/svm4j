...
/**
 * &nu;-SVR: The configuration for support vector limited regression.
 * 
 * @author <a href="mailto:jiangfan0576@gmail.com">Frank Jiang</a>
 * @version 1.0.0
 */
public class ParameterNuSVR extends AbstractParameter
{
	/**
	...
	/**
	 * Construct a default <tt>ParameterNuSVR</tt>.
	 */
	public ParameterNuSVR()
	{
		this(1.0, 0.5);
	}

	/**
	 * Construct an instance of <tt>ParameterNuSVR</tt> with specified cost
	 ...
	 */
	public ParameterNuSVR(double cost, double nu)
	{
		setCost(cost);
		setNu(nu);
